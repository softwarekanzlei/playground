package com.softwarekanzlei.lab.pdfbox;
...
public class RunPDFBox {
		  ...
		  private static Logger LOG = LogManager.getLogger(RunPDFBox.class);

	public static void main(String[] args)  {

		try {
			LOG.info("START: " + RunPDFBox.class.getSimpleName());
			test();
			LOG.info("END  : " + RunPDFBox.class.getSimpleName());
		} catch (Exception e) {
			LOG.error(e,e);
		}
